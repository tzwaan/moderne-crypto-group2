...
def Oracle_Connect():
    ...
    global mac_sock
    global vrfy_sock
    mac_sock, vrfy_sock = (socket.socket(socket.AF_INET, socket.SOCK_STREAM),
                           socket.socket(socket.AF_INET, socket.SOCK_STREAM))
    try:
        mac_sock.connect((ip_address, 49102))
        vrfy_sock.connect((ip_address, 49103))
...
# Packet Structure: < mlength(1) || message(mlength)
#   || tag(16) || null-terminator(1) >
